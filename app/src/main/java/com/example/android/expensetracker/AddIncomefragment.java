...
*/
    ...
    private void loadacc() {
        ...
        if (in_acc_modelArrayList.size() == 0) {
            in_acc_model = new In_Acc_Model();
            in_acc_model.setIn_acc_type("Account");

            db.addInAcc(in_acc_model);

            in_acc_model1 = new In_Acc_Model();
            in_acc_model1.setIn_acc_type("Cash");
            db.addInAcc(in_acc_model1);

            in_acc_model2 = new In_Acc_Model();
            in_acc_model2.setIn_acc_type("Card");
            db.addInAcc(in_acc_model2);
            ...
            for(int i=0;i<in_acc_modelArrayList.size();i++){
                ...
                in_acc_model.setIn_acc_type(acctype);
                ...
                catbtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (catval.equals("")) {
                            ...
                            in_catg_modelArrayList = db.getAllInType();
                            for(int i=0;i<in_catg_modelArrayList.size();i++){
                                In_Catg_model in_catg_model1=new In_Catg_model();
                                in_catg_model1=in_catg_modelArrayList.get(i);
                                oldcatvl=in_catg_model1.getIn_cat_type();


                            }
                            if(catval.matches(oldcatvl)){
